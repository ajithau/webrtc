                                ...
                                <li>
                                    <a href="{{ url('/') }}/live-stream-detail/{{$station->id}}" class="thumbnail">
                                        ...
                                        <div class="padding-top-bottom-10">
                                            ...
                                            <br/>
                                            <?php 
                                                if (strpos($json, $station->station_instance) !== false) {
                                                    echo '<small class="text-muted">Online</small><i class="fa fa-circle online"></i>';
                                                } else {
                                                    echo '<small class="text-muted">Offline</small><i class="fa fa-circle offline"></i>';
                                                }
                                            ?>
                                        </div>
                                    </a>
