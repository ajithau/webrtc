                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <ul class="list-inline">
                            ...
                            <li>
                                <div class="thumbnail" >
                                    <img data-toggle="modal" data-target="#usc-video-{{$video->id}}" src="{{ url('/') }}/public/user-videos/{{ $image[0] }}_290.jpg" width="295" height="220" alt="">
                                    <div>
                    ...
                    <script type="text/javascript">
                         var playerInstance = jwplayer("player{{$i}}");
                            playerInstance.setup({
                            image: "{{ url('/') }}/public/user-videos/{{ $image[0] }}_600.jpg", 
                            sources: [{ 
