            ...
            <div class="ibox float-e-margins">
                ...
                <table class="table table-hover table-bordered table-responsive">
                    ...
                    <tr>
						...
						<td class="" id="create">{{ $user->created_at }}</td>
						<td class="" id="update">{{ $user->updated_at }}</td>
                        <td>
                            <div class="text-center">
                                <button class="btn btn-xs btn-primary" type="button"><i class="fa fa-pencil" data-toggle="modal" data-target="#edit-user{{ $user->name }}"></i></button>
                            </div>
                        </td>
                        <td>
                            <div class="text-center">
                                <button class="btn btn-xs btn-primary" type="button"><i class="fa fa-times deleteUser" value="{{ $user->user_id }}"></i></button>
                            </div>
                        </td>					
                    </tr>
                        <!-- START: Modal -->
