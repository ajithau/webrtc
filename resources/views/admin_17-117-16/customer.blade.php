        ...
        {!! Form::open(array('url' => 'users/createCustomer')) !!}
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    {{ Form::text('phone', '', array('class' => 'form-control', 'placeholder' => 'Enter Telephone')) }} 
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
             ...
             <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    {{ Form::text('website', '', array('class' => 'form-control', 'placeholder' => 'Enter Website URL')) }} 
                    </div>
                </div>
            </div>
            <div class="row">
                              ...
                              <div class="panel-body" id="new-user">
                                ...
                                {!! Form::open(array('url' => '')) !!}
                                    ...
                                    <select name="user_type" id="" class="form-control">
                                        ...
                                        <option value="3" @if($user->role == 3) selected @endif>Content Editor</option>
                                    </select>
                                    </div>
                                    <div class="row">
                                            <div class="col-sm-6">
