...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li <?php if($segment == 'users'): ?> class='active' <?php endif; ?> >
                <a href="users"><i class="fa fa-male"></i> <span class="nav-label">User Management</span></a>
            </li> 
            <li  <?php if($segment == 'videos'): ?> class='active' <?php endif; ?> >
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li  <?php if($segment == 'videos'): ?> class='active' <?php endif; ?> ><a href="videos">Video Library</a></li>
